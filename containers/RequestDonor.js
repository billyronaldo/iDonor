...
class RequestDonor extends Component{
    ...
    constructor(props) {
      ...
      onSubmit(){
        ...
        if(name === '' && noHp === '' && note === '' && golDarah === '' && lokasi === '' ) {
    ...
    render(){
        return(
                      <KeyboardAwareScrollView behavior={Platform.select({android: 'padding', ios: 'padding'})}>
                 <View style={{marginHorizontal: normalize(20), marginVertical: normalize(15)}}>
                   <Text style={{fontSize: fontSize.large, marginBottom: normalize(5)}}>Form Request Donor</Text>
